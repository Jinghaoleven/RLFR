...
setup(
    ...
    description="RLFR: Extending Reinforcement Learning for LLMs with Flow Environment",
    long_description=_fetch_readme(),
    long_description_content_type="text/markdown",
    install_requires=_fetch_requirements("requirements.txt"),
    extras_require={
        "eval": ["fire", "termcolor", "pydantic", "pylatexenc", "flashinfer-python", "validators", "tabulate", "sty", "portalocker", "decord", "imageio", "timeout-decorator", "ipdb", "nltk", "latex2sympy2", "xlsxwriter", "lmdeploy", "openpyxl"],
    },
