...
PRETRAIN_MODEL_PATH=Qwen/Qwen2.5-Math-1.5B   # Path to pretrained model
PRETRAINED_FLOW=$PROJECT_ROOT/result/Qwen2.5-Math-1.5B/flow_model/checkpoint-***
FLOW_CONFIG=$PROJECT_ROOT/config/flow_config_3B.json

SAVE_PATH=$PROJECT_ROOT/result/Qwen2.5-Math-1.5B/RL        # Path to save checkpoints
LOG_PATH=$PROJECT_ROOT/log_dir
export NODE_RANK=0
export MASTER_ADDR="127.0.0.1"

# Model configuration
PROJECT_NAME="Qwen2.5-Math-1.5B-math_lvl3to5_8k"
...
ray job submit --address="http://127.0.0.1:8265" \
   ...
   --experience_sampling_metrics batch_correct \
