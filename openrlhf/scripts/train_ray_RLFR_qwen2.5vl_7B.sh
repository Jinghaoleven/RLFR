...
PRETRAINED_FLOW=$PROJECT_ROOT/result/Qwen2_5VL-7B/flow_model/checkpoint-***
FLOW_CONFIG=$PROJECT_ROOT/config/flow_config_7B.json

SAVE_PATH=$PROJECT_ROOT/result/Qwen2_5VL-7B/RL       # Path to save checkpoints
LOG_PATH=$PROJECT_ROOT/log_dir

# Model configuration
PROJECT_NAME="Qwen2.5-VL-7B-Instruct"
EXP_NAME="RLFR"              # Name for this training run
