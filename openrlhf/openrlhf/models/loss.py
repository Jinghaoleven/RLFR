...
class PolicyLoss(nn.Module):
    ...
    def __init__(self, clip_eps: float = 0.2, clip_high: float = 0.28, use_dapo: bool = False) -> None:
        super().__init__()
        self.clip_eps = clip_eps
        self.use_dapo = use_dapo
        self.clip_high = clip_high if use_dapo else clip_eps
    ...
    def forward(
        ...
        surr2 = ratio.clamp(1 - self.clip_eps, 1 + self.clip_high) * advantages
